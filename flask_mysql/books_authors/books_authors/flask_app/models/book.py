...
class Book:
    ...
    def get_all(cls):
        ...
        books = []
        results = connectToMySQL('books_and_authors').query_db(query)
        for row in results:
    ...
    def save(cls,data):
        ...
        return connectToMySQL('books_and_authors').query_db(query,data)
    ...
    def get_by_id(cls,data):
        ...
        results = connectToMySQL('books_and_authors').query_db(query,data)
